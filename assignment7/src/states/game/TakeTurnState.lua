    ...
    Timer.after(0.5, function()
        ...
        :finish(function()
            ...
            :finish(function()
				...
				local defHealth = defender.currentHP - dmg
				
				if (defHealth / defender.HP  < 0.25) then
						defenderBar.color = {r = 255, g = 0, b = 0}
					elseif (defHealth / defender.HP) < 0.5 then
						defenderBar.color = {r = 255, g = 255, b = 0}
					end
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        HPIncrease, attackIncrease, defenseIncrease, speedIncrease = self.playerPokemon:levelUp() --return the increased values from levelUp
						
						--table for our increased stats
						increase = {
							HP = HPIncrease
                        ...
                        gStateStack:push(BattleMessageState('Congratulations! Level Up!'), nil, false)
                        gStateStack:push(LevelUpMenuState({
							--table for our current values
							current = {
							...
							increase = increase --table of increased values to pass through
						},
						function()
						gStateStack:pop()
