...
gTextures = {
	...
	['keyandblock'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
	...
	['keyandblock'] = GenerateQuads(gTextures['keyandblock'], 16, 16),
	['flagpole'] = GenerateQuads(gTextures['flagpole'], 16, 64),
