...
function Paddle:init(skin, size)
    ...
    -- starting dimensions
    self.width = 32 * size	--multiply minimum width by size to account for changing width as size increases and decreases
    self.height = 16
	...
	--this is defined in paddleselectstate, after that the size changes on score/ loss of life
    self.size = size
end
