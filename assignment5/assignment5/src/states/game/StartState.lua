...
function StartState:render()
    ...
    love.graphics.printf('Legend of Paddy', 2, VIRTUAL_HEIGHT / 2 - 30, VIRTUAL_WIDTH, 'center')

    love.graphics.setColor(175/255, 53/255, 42/255, 255/255)
    love.graphics.printf('Legend of Paddy', 0, VIRTUAL_HEIGHT / 2 - 32, VIRTUAL_WIDTH, 'center')
