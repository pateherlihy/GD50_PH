...
gSounds = {
    ['field-music'] = newSource('sounds/field_music.wav'),
    ['battle-music'] = newSource('sounds/battle_music.mp3'),
    ['blip'] = newSource('sounds/blip.wav'),
    ['powerup'] = newSource('sounds/powerup.wav'),
    ['hit'] = newSource('sounds/hit.wav'),
    ['run'] = newSource('sounds/run.wav'),
    ['heal'] = newSource('sounds/heal.wav'),
    ['exp'] = newSource('sounds/exp.wav'),
    ['levelup'] = newSource('sounds/levelup.wav'),
    ['victory-music'] = newSource('sounds/victory.wav'),
    ['intro-music'] = newSource('sounds/intro.mp3')
}