...
function BattleState:init(player)
	...
	local colour = {r = 0, g = 128, b = 0}
	if self.player.party.pokemon[1].currentHP / self.player.party.pokemon[1].HP < 0.25 then
		colour = {r = 255, g = 0, b = 0}
	elseif self.player.party.pokemon[1].currentHP / self.player.party.pokemon[1].HP < 0.5 then
...
function BattleState:render()
    clear255(214, 214, 214, 255)

    set255Colour(45, 184, 45, 124)
